...
export default function CameraCard() {
  ...
  return (
    <div className="w-full max-w-sm sm:max-w-md md:w-96 bg-white rounded-2xl shadow-lg p-6 sm:p-8 mx-4">
      ...
      <div className="mb-6 w-full relative" style={{ minHeight: scanning ? 'auto' : '0' }}>
        {/* Placeholder - shown when NOT scanning */}
        <div 
          className="w-full rounded-lg flex flex-col items-center justify-center gap-4 border-2 border-dashed border-gray-300 bg-gradient-to-br from-gray-100 to-gray-200"
          style={{ 
