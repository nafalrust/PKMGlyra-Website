  ...
  return (
    <div className="w-full max-w-sm sm:max-w-md md:w-96 bg-white rounded-2xl shadow-lg p-4 sm:p-6 mx-2 sm:mx-4">
      ...
      <div className="mb-2 w-full relative" style={{ minHeight: scanning ? 'auto' : '0' }}>
        ...
        <div 
          className="w-full rounded-lg flex flex-col items-center justify-center gap-1.5 sm:gap-2 border-2 border-dashed border-gray-300 bg-gradient-to-br from-gray-100 to-gray-200 p-3 sm:p-4"
          style={{ 
